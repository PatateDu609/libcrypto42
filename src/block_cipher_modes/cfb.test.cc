...
static const std::vector<BlockCipherTestParams> cfb_3des_ede3_params{
	CREATE_CFB_TEST(BLOCK_CIPHER_3DES_EDE3, 0),   CREATE_CFB_TEST(BLOCK_CIPHER_3DES_EDE3, 1),
	CREATE_CFB_TEST(BLOCK_CIPHER_3DES_EDE3, 8),   CREATE_CFB_TEST(BLOCK_CIPHER_3DES_EDE3, 16),
	CREATE_CFB_TEST(BLOCK_CIPHER_3DES_EDE3, 26),  CREATE_CFB_TEST(BLOCK_CIPHER_3DES_EDE3, 31),
	CREATE_CFB_TEST(BLOCK_CIPHER_3DES_EDE3, 32),  CREATE_CFB_TEST(BLOCK_CIPHER_3DES_EDE3, 73),
	CREATE_CFB_TEST(BLOCK_CIPHER_3DES_EDE3, 79),  CREATE_CFB_TEST(BLOCK_CIPHER_3DES_EDE3, 128),
	CREATE_CFB_TEST(BLOCK_CIPHER_3DES_EDE3, 512),
};

static const std::vector<BlockCipherTestParams> cfb_3des_ede2_params{
	CREATE_CFB_TEST(BLOCK_CIPHER_3DES_EDE2, 0),   CREATE_CFB_TEST(BLOCK_CIPHER_3DES_EDE2, 1),
	CREATE_CFB_TEST(BLOCK_CIPHER_3DES_EDE2, 8),   CREATE_CFB_TEST(BLOCK_CIPHER_3DES_EDE2, 16),
	CREATE_CFB_TEST(BLOCK_CIPHER_3DES_EDE2, 26),  CREATE_CFB_TEST(BLOCK_CIPHER_3DES_EDE2, 31),
	CREATE_CFB_TEST(BLOCK_CIPHER_3DES_EDE2, 32),  CREATE_CFB_TEST(BLOCK_CIPHER_3DES_EDE2, 73),
	CREATE_CFB_TEST(BLOCK_CIPHER_3DES_EDE2, 79),  CREATE_CFB_TEST(BLOCK_CIPHER_3DES_EDE2, 128),
	CREATE_CFB_TEST(BLOCK_CIPHER_3DES_EDE2, 512),
};
...
static const std::vector<BlockCipherTestParams> cfb1_3des_ede3_params{
	CREATE_CFB1_TEST(BLOCK_CIPHER_3DES_EDE3, 0),   CREATE_CFB1_TEST(BLOCK_CIPHER_3DES_EDE3, 1),
	CREATE_CFB1_TEST(BLOCK_CIPHER_3DES_EDE3, 8),   CREATE_CFB1_TEST(BLOCK_CIPHER_3DES_EDE3, 16),
	CREATE_CFB1_TEST(BLOCK_CIPHER_3DES_EDE3, 26),  CREATE_CFB1_TEST(BLOCK_CIPHER_3DES_EDE3, 31),
	CREATE_CFB1_TEST(BLOCK_CIPHER_3DES_EDE3, 32),  CREATE_CFB1_TEST(BLOCK_CIPHER_3DES_EDE3, 73),
	CREATE_CFB1_TEST(BLOCK_CIPHER_3DES_EDE3, 79),  CREATE_CFB1_TEST(BLOCK_CIPHER_3DES_EDE3, 128),
	CREATE_CFB1_TEST(BLOCK_CIPHER_3DES_EDE3, 512),
};
...
static const std::vector<BlockCipherTestParams> cfb8_3des_ede3_params{
	CREATE_CFB8_TEST(BLOCK_CIPHER_3DES_EDE3, 0),   CREATE_CFB8_TEST(BLOCK_CIPHER_3DES_EDE3, 1),
	CREATE_CFB8_TEST(BLOCK_CIPHER_3DES_EDE3, 8),   CREATE_CFB8_TEST(BLOCK_CIPHER_3DES_EDE3, 16),
	CREATE_CFB8_TEST(BLOCK_CIPHER_3DES_EDE3, 26),  CREATE_CFB8_TEST(BLOCK_CIPHER_3DES_EDE3, 31),
	CREATE_CFB8_TEST(BLOCK_CIPHER_3DES_EDE3, 32),  CREATE_CFB8_TEST(BLOCK_CIPHER_3DES_EDE3, 73),
	CREATE_CFB8_TEST(BLOCK_CIPHER_3DES_EDE3, 79),  CREATE_CFB8_TEST(BLOCK_CIPHER_3DES_EDE3, 128),
	CREATE_CFB8_TEST(BLOCK_CIPHER_3DES_EDE3, 512),
};
...
INSTANTIATE_TEST_SUITE_P(tdes2, CFBTests, testing::ValuesIn(cfb_3des_ede2_params));
INSTANTIATE_TEST_SUITE_P(tdes3, CFBTests, testing::ValuesIn(cfb_3des_ede3_params));
...
INSTANTIATE_TEST_SUITE_P(tdes3, CFB1Tests, testing::ValuesIn(cfb1_3des_ede3_params));
...
INSTANTIATE_TEST_SUITE_P(tdes3, CFB8Tests, testing::ValuesIn(cfb8_3des_ede3_params));
